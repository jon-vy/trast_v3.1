...
class SQLiteDB:
    def __init__(self, db_name):
        ...
        self.connect_sqlite3 = None

    def __enter__(self):
        self.connect_sqlite3 = sqlite3.connect(self.db_name)
        return self.connect_sqlite3

    def __exit__(self, exc_type, exc_value, traceback):
        if self.connect_sqlite3:
...
class WindowDialogSetting(QDialog):
    def __init__(self):
        ...
        with SQLiteDB("database.db") as self.connect_sqlite3:
            self.cursor_sqlite3 = self.connect_sqlite3.cursor()
